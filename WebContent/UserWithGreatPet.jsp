...
<div class="container-fluid text-center ">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
	  ...
	  <h4> Breeders who have never posted <b>Ridic Adorbs</b> Animal
	  </h4>
      <hr>
      ...
      <tbody>
      <c:forEach var = "user" items = "${GoodUserList2}" varStatus = "loop">
      <tr>
      ...
      <th scope = "col">Full Name</th>
      <th scope = "col">Pets For Adoption</th>
      <th scope = "col">Pet with Great Review</th>
      </tr>
      </thead>
      <tbody>
      ...
      <td><a href ="Userinfo?id=${user.id} "><c:out value = "${user.getFirstName() }" />  <c:out value = "${user.getLastName() }" /></a></td>
      <td><c:out value = "${user.getPetCounts() }" /></td>
      <td><a href="PetReviewList?petId=${user.getpetId() }"><c:out value = "${user.getpetName() }" /></a></td>
      </tr>
      </c:forEach>
      </tbody>
      </table>
